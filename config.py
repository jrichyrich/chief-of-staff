...
IMESSAGE_DAEMON_ALLOWED_SENDERS = tuple(
    s.strip() for s in os.environ.get("IMESSAGE_DAEMON_ALLOWED_SENDERS", "").split(",") if s.strip()
)
IMESSAGE_DAEMON_COMMAND_PREFIX = os.environ.get("IMESSAGE_DAEMON_COMMAND_PREFIX", "jarvis")
